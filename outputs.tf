output "resource_group_policy_exemptions_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.id }
}
output "resource_group_policy_exemptions_description" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.description }
}
output "resource_group_policy_exemptions_display_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.display_name }
}
output "resource_group_policy_exemptions_exemption_category" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.exemption_category }
}
output "resource_group_policy_exemptions_expires_on" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.expires_on }
}
output "resource_group_policy_exemptions_metadata" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.metadata }
}
output "resource_group_policy_exemptions_name" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.name }
}
output "resource_group_policy_exemptions_policy_assignment_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.policy_assignment_id }
}
output "resource_group_policy_exemptions_policy_definition_reference_ids" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.policy_definition_reference_ids }
}
output "resource_group_policy_exemptions_resource_group_id" {
  ...
  value       = { for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : k => v.resource_group_id }
}
