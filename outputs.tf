output "resource_group_policy_exemptions" {
  ...
  value       = azurerm_resource_group_policy_exemption.resource_group_policy_exemptions
}
output "resource_group_policy_exemptions_description" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.description]
}
output "resource_group_policy_exemptions_display_name" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.display_name]
}
output "resource_group_policy_exemptions_exemption_category" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.exemption_category]
}
output "resource_group_policy_exemptions_expires_on" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.expires_on]
}
output "resource_group_policy_exemptions_metadata" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.metadata]
}
output "resource_group_policy_exemptions_name" {
  description = "List of name values across all resource_group_policy_exemptions"
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.name]
}
output "resource_group_policy_exemptions_policy_assignment_id" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.policy_assignment_id]
}
output "resource_group_policy_exemptions_policy_definition_reference_ids" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.policy_definition_reference_ids]
}
output "resource_group_policy_exemptions_resource_group_id" {
  ...
  value       = [for k, v in azurerm_resource_group_policy_exemption.resource_group_policy_exemptions : v.resource_group_id]
}
